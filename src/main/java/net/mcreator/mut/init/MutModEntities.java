...
import net.mcreator.mut.entity.AborigineZombieEntity;
...
public class MutModEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AborigineZombieEntity>> ABORIGINE_ZOMBIE = register("aborigine_zombie",
			EntityType.Builder.<AborigineZombieEntity>of(AborigineZombieEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
	...
	public static final DeferredHolder<EntityType<?>, EntityType<RedLightningCreeperEntity>> RED_LIGHTNING_CREEPER = register("red_lightning_creeper",
			EntityType.Builder.<RedLightningCreeperEntity>of(RedLightningCreeperEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
	...
	public static final DeferredHolder<EntityType<?>, EntityType<TravelerPhantomEntity>> TRAVELER_PHANTOM = register("traveler_phantom",
			EntityType.Builder.<TravelerPhantomEntity>of(TravelerPhantomEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(128).setUpdateInterval(3)

					.sized(0.9f, 0.5f));
	public static final DeferredHolder<EntityType<?>, EntityType<LittleCreeperEntity>> LITTLE_CREEPER = register("little_creeper",
			EntityType.Builder.<LittleCreeperEntity>of(LittleCreeperEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
	...
	public static final DeferredHolder<EntityType<?>, EntityType<EliteAborigineZombieEntity>> ELITE_ABORIGINE_ZOMBIE = register("elite_aborigine_zombie",
			EntityType.Builder.<EliteAborigineZombieEntity>of(EliteAborigineZombieEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
