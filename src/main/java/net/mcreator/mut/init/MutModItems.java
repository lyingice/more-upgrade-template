...
public class MutModItems {
	...
	public static final DeferredItem<Item> BLUE_DIAMOND_ROSE;
	public static final DeferredItem<Item> BLUE_DIAMOND_ROSEBUSH;
	public static final DeferredItem<Item> GILDED_MARIGOLD_FLOWER;
	public static final DeferredItem<Item> SIGIL_FORGE_SANDSTONE;
	public static final DeferredItem<Item> SIGIL_FORGE_SANDSTONE_STAIRS;
	public static final DeferredItem<Item> SIGIL_FORGE_SANDSTONE_SLAB;
	public static final DeferredItem<Item> SIGIL_FORGE_SANDSTONE_WALL;
	public static final DeferredItem<Item> SIGIL_FORGE_CUT_SANDSTONE;
	public static final DeferredItem<Item> SIGIL_FORGE_CUT_SANDSTONE_STAIRS;
	public static final DeferredItem<Item> SIGIL_FORGE_CUT_SANDSTONE_SLAB;
	public static final DeferredItem<Item> SIGIL_FORGE_CUT_SANDSTONE_WALL;
	public static final DeferredItem<Item> SIGIL_FORGE_CHISELED_SANDSTONE;
	public static final DeferredItem<Item> SIGIL_FORGE_CHISELED_SANDSTONE_STAIRS;
	public static final DeferredItem<Item> SIGIL_FORGE_CHISELED_SANDSTONE_SLAB;
	public static final DeferredItem<Item> SIGIL_FORGE_CHISELED_SANDSTONE_WALL;
	public static final DeferredItem<Item> DIAMOND_LAMP;
	public static final DeferredItem<Item> WHITE_DIAMOND_LAMP;
	public static final DeferredItem<Item> LIGHT_GRAY_DIAMOND_LAMP;
	public static final DeferredItem<Item> GRAY_DIAMOND_LAMP;
	public static final DeferredItem<Item> BLACK_DIAMOND_LAMP;
	public static final DeferredItem<Item> BROWN_DIAMOND_LAMP;
	public static final DeferredItem<Item> RED_DIAMOND_LAMP;
	public static final DeferredItem<Item> ORANGE_DIAMOND_LAMP;
	public static final DeferredItem<Item> YELLOW_DIAMOND_LAMP;
	public static final DeferredItem<Item> LIME_DIAMOND_LAMP;
	public static final DeferredItem<Item> GREEN_DIAMOND_LAMP;
	public static final DeferredItem<Item> CYAN_DIAMOND_LAMP;
	public static final DeferredItem<Item> LIGHT_BLUE_DIAMOND_LAMP;
	public static final DeferredItem<Item> BLUE_DIAMOND_LAMP;
	public static final DeferredItem<Item> PURPLE_DIAMOND_LAMP;
	public static final DeferredItem<Item> MAGENTA_DIAMOND_LAMP;
	public static final DeferredItem<Item> PINK_DIAMOND_LAMP;
	public static final DeferredItem<Item> SIGIL_FORGE_SMOOTH_SANDSTONE;
	public static final DeferredItem<Item> SIGIL_FORGE_SMOOTH_SANDSTONE_STAIRS;
	public static final DeferredItem<Item> SIGIL_FORGE_SMOOTH_SANDSTONE_SLAB;
	public static final DeferredItem<Item> SIGIL_FORGE_SMOOTH_SANDSTONE_WALL;
	public static final DeferredItem<Item> EMPEROR_DEBRIS_CACTUS;
	public static final DeferredItem<Item> DEBRIS_SIGIL_MAGMA_BLOCK;
	public static final DeferredItem<Item> DEBRIS_APPLE;
	public static final DeferredItem<Item> STEEL_DEBRIS_APPLE;
	...
	static {
		...
		BLUE_DIAMOND_ROSE = block(MutModBlocks.BLUE_DIAMOND_ROSE, new Item.Properties().fireResistant());
		BLUE_DIAMOND_ROSEBUSH = doubleBlock(MutModBlocks.BLUE_DIAMOND_ROSEBUSH, new Item.Properties().fireResistant());
		GILDED_MARIGOLD_FLOWER = block(MutModBlocks.GILDED_MARIGOLD_FLOWER, new Item.Properties().fireResistant());
		SIGIL_FORGE_SANDSTONE = block(MutModBlocks.SIGIL_FORGE_SANDSTONE);
		SIGIL_FORGE_SANDSTONE_STAIRS = block(MutModBlocks.SIGIL_FORGE_SANDSTONE_STAIRS);
		SIGIL_FORGE_SANDSTONE_SLAB = block(MutModBlocks.SIGIL_FORGE_SANDSTONE_SLAB);
		SIGIL_FORGE_SANDSTONE_WALL = block(MutModBlocks.SIGIL_FORGE_SANDSTONE_WALL);
		SIGIL_FORGE_CUT_SANDSTONE = block(MutModBlocks.SIGIL_FORGE_CUT_SANDSTONE);
		SIGIL_FORGE_CUT_SANDSTONE_STAIRS = block(MutModBlocks.SIGIL_FORGE_CUT_SANDSTONE_STAIRS);
		SIGIL_FORGE_CUT_SANDSTONE_SLAB = block(MutModBlocks.SIGIL_FORGE_CUT_SANDSTONE_SLAB);
		SIGIL_FORGE_CUT_SANDSTONE_WALL = block(MutModBlocks.SIGIL_FORGE_CUT_SANDSTONE_WALL);
		SIGIL_FORGE_CHISELED_SANDSTONE = block(MutModBlocks.SIGIL_FORGE_CHISELED_SANDSTONE);
		SIGIL_FORGE_CHISELED_SANDSTONE_STAIRS = block(MutModBlocks.SIGIL_FORGE_CHISELED_SANDSTONE_STAIRS);
		SIGIL_FORGE_CHISELED_SANDSTONE_SLAB = block(MutModBlocks.SIGIL_FORGE_CHISELED_SANDSTONE_SLAB);
		SIGIL_FORGE_CHISELED_SANDSTONE_WALL = block(MutModBlocks.SIGIL_FORGE_CHISELED_SANDSTONE_WALL);
		DIAMOND_LAMP = block(MutModBlocks.DIAMOND_LAMP);
		WHITE_DIAMOND_LAMP = block(MutModBlocks.WHITE_DIAMOND_LAMP);
		LIGHT_GRAY_DIAMOND_LAMP = block(MutModBlocks.LIGHT_GRAY_DIAMOND_LAMP);
		GRAY_DIAMOND_LAMP = block(MutModBlocks.GRAY_DIAMOND_LAMP);
		BLACK_DIAMOND_LAMP = block(MutModBlocks.BLACK_DIAMOND_LAMP);
		BROWN_DIAMOND_LAMP = block(MutModBlocks.BROWN_DIAMOND_LAMP);
		RED_DIAMOND_LAMP = block(MutModBlocks.RED_DIAMOND_LAMP);
		ORANGE_DIAMOND_LAMP = block(MutModBlocks.ORANGE_DIAMOND_LAMP);
		YELLOW_DIAMOND_LAMP = block(MutModBlocks.YELLOW_DIAMOND_LAMP);
		LIME_DIAMOND_LAMP = block(MutModBlocks.LIME_DIAMOND_LAMP);
		GREEN_DIAMOND_LAMP = block(MutModBlocks.GREEN_DIAMOND_LAMP);
		CYAN_DIAMOND_LAMP = block(MutModBlocks.CYAN_DIAMOND_LAMP);
		LIGHT_BLUE_DIAMOND_LAMP = block(MutModBlocks.LIGHT_BLUE_DIAMOND_LAMP);
		BLUE_DIAMOND_LAMP = block(MutModBlocks.BLUE_DIAMOND_LAMP);
		PURPLE_DIAMOND_LAMP = block(MutModBlocks.PURPLE_DIAMOND_LAMP);
		MAGENTA_DIAMOND_LAMP = block(MutModBlocks.MAGENTA_DIAMOND_LAMP);
		PINK_DIAMOND_LAMP = block(MutModBlocks.PINK_DIAMOND_LAMP);
		SIGIL_FORGE_SMOOTH_SANDSTONE = block(MutModBlocks.SIGIL_FORGE_SMOOTH_SANDSTONE);
		SIGIL_FORGE_SMOOTH_SANDSTONE_STAIRS = block(MutModBlocks.SIGIL_FORGE_SMOOTH_SANDSTONE_STAIRS);
		SIGIL_FORGE_SMOOTH_SANDSTONE_SLAB = block(MutModBlocks.SIGIL_FORGE_SMOOTH_SANDSTONE_SLAB);
		SIGIL_FORGE_SMOOTH_SANDSTONE_WALL = block(MutModBlocks.SIGIL_FORGE_SMOOTH_SANDSTONE_WALL);
		EMPEROR_DEBRIS_CACTUS = block(MutModBlocks.EMPEROR_DEBRIS_CACTUS, new Item.Properties().fireResistant());
		DEBRIS_SIGIL_MAGMA_BLOCK = block(MutModBlocks.DEBRIS_SIGIL_MAGMA_BLOCK, new Item.Properties().fireResistant());
		DEBRIS_APPLE = REGISTRY.register("debris_apple", DebrisAppleItem::new);
		STEEL_DEBRIS_APPLE = REGISTRY.register("steel_debris_apple", SteelDebrisAppleItem::new);
	...
	public static DeferredItem<Item> STEEL_SPEAR;
	public static DeferredItem<Item> ADVANCED_STEEL_SPEAR;
	public static DeferredItem<Item> GILDING_SPEAR;
	public static DeferredItem<Item> BLUE_DIAMOND_SPEAR;
	public static DeferredItem<Item> OBSIDIAN_SPEAR;
	public static DeferredItem<Item> NETHERITE_OBSIDIAN_SPEAR;
	public static DeferredItem<Item> CRYING_OBSIDIAN_SPEAR;
	public static DeferredItem<Item> EMERALD_SPEAR;
	public static DeferredItem<Item> NETHERITE_EMERALD_SPEAR;
	public static DeferredItem<Item> NETHERITE_REDSTONE_SPEAR;
	public static DeferredItem<Item> NETHER_STAR_SPEAR;
	public static DeferredItem<Item> WITHER_SPEAR;
	public static DeferredItem<Item> DRAGON_SPEAR;
	public static DeferredItem<Item> AMETHYST_SPEAR;
	public static DeferredItem<Item> NETHERITE_AMETHYST_SPEAR;
	public static DeferredItem<Item> NETHERITE_COPPER_SPEAR;
	...
	public static DeferredItem<Item> LAPIS_LAZULI_SPEAR;
	public static DeferredItem<Item> NETHERITE_LAPIS_LAZULI_SPEAR;
	public static DeferredItem<Item> ECHOITE_SPEAR;
	public static DeferredItem<Item> POISON_STEEL_SPEAR;
	public static DeferredItem<Item> FLAME_GOLD_SPEAR;
	public static DeferredItem<Item> THUNDER_COPPER_SPEAR;
	public static DeferredItem<Item> UNCANNY_AMETHYST_SPEAR;
	// wither tools
