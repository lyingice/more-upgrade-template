...
public class MutModBlocks {
	...
	public static final DeferredBlock<Block> BLUE_DIAMOND_ROSE;
	public static final DeferredBlock<Block> BLUE_DIAMOND_ROSEBUSH;
	public static final DeferredBlock<Block> GILDED_MARIGOLD_FLOWER;
	public static final DeferredBlock<Block> SIGIL_FORGE_SANDSTONE;
	public static final DeferredBlock<Block> SIGIL_FORGE_SANDSTONE_STAIRS;
	public static final DeferredBlock<Block> SIGIL_FORGE_SANDSTONE_SLAB;
	public static final DeferredBlock<Block> SIGIL_FORGE_SANDSTONE_WALL;
	public static final DeferredBlock<Block> SIGIL_FORGE_CUT_SANDSTONE;
	public static final DeferredBlock<Block> SIGIL_FORGE_CUT_SANDSTONE_STAIRS;
	public static final DeferredBlock<Block> SIGIL_FORGE_CUT_SANDSTONE_SLAB;
	public static final DeferredBlock<Block> SIGIL_FORGE_CUT_SANDSTONE_WALL;
	public static final DeferredBlock<Block> SIGIL_FORGE_CHISELED_SANDSTONE;
	public static final DeferredBlock<Block> SIGIL_FORGE_CHISELED_SANDSTONE_STAIRS;
	public static final DeferredBlock<Block> SIGIL_FORGE_CHISELED_SANDSTONE_SLAB;
	public static final DeferredBlock<Block> SIGIL_FORGE_CHISELED_SANDSTONE_WALL;
	public static final DeferredBlock<Block> DIAMOND_LAMP;
	public static final DeferredBlock<Block> WHITE_DIAMOND_LAMP;
	public static final DeferredBlock<Block> LIGHT_GRAY_DIAMOND_LAMP;
	public static final DeferredBlock<Block> GRAY_DIAMOND_LAMP;
	public static final DeferredBlock<Block> BLACK_DIAMOND_LAMP;
	public static final DeferredBlock<Block> BROWN_DIAMOND_LAMP;
	public static final DeferredBlock<Block> RED_DIAMOND_LAMP;
	public static final DeferredBlock<Block> ORANGE_DIAMOND_LAMP;
	public static final DeferredBlock<Block> YELLOW_DIAMOND_LAMP;
	public static final DeferredBlock<Block> LIME_DIAMOND_LAMP;
	public static final DeferredBlock<Block> GREEN_DIAMOND_LAMP;
	public static final DeferredBlock<Block> CYAN_DIAMOND_LAMP;
	public static final DeferredBlock<Block> LIGHT_BLUE_DIAMOND_LAMP;
	public static final DeferredBlock<Block> BLUE_DIAMOND_LAMP;
	public static final DeferredBlock<Block> PURPLE_DIAMOND_LAMP;
	public static final DeferredBlock<Block> MAGENTA_DIAMOND_LAMP;
	public static final DeferredBlock<Block> PINK_DIAMOND_LAMP;
	public static final DeferredBlock<Block> SIGIL_FORGE_SMOOTH_SANDSTONE;
	public static final DeferredBlock<Block> SIGIL_FORGE_SMOOTH_SANDSTONE_STAIRS;
	public static final DeferredBlock<Block> SIGIL_FORGE_SMOOTH_SANDSTONE_SLAB;
	...
	static {
		...
		BLUE_DIAMOND_ROSE = REGISTRY.register("blue_diamond_rose", BlueDiamondRoseBlock::new);
		BLUE_DIAMOND_ROSEBUSH = REGISTRY.register("blue_diamond_rosebush", BlueDiamondRosebushBlock::new);
		GILDED_MARIGOLD_FLOWER = REGISTRY.register("gilded_marigold_flower", GildedMarigoldFlowerBlock::new);
		SIGIL_FORGE_SANDSTONE = REGISTRY.register("sigil_forge_sandstone", SigilForgeSandstoneBlock::new);
		SIGIL_FORGE_SANDSTONE_STAIRS = REGISTRY.register("sigil_forge_sandstone_stairs", SigilForgeSandstoneStairsBlock::new);
		SIGIL_FORGE_SANDSTONE_SLAB = REGISTRY.register("sigil_forge_sandstone_slab", SigilForgeSandstoneSlabBlock::new);
		SIGIL_FORGE_SANDSTONE_WALL = REGISTRY.register("sigil_forge_sandstone_wall", SigilForgeSandstoneWallBlock::new);
		SIGIL_FORGE_CUT_SANDSTONE = REGISTRY.register("sigil_forge_cut_sandstone", SigilForgeCutSandstoneBlock::new);
		SIGIL_FORGE_CUT_SANDSTONE_STAIRS = REGISTRY.register("sigil_forge_cut_sandstone_stairs", SigilForgeCutSandstoneStairsBlock::new);
		SIGIL_FORGE_CUT_SANDSTONE_SLAB = REGISTRY.register("sigil_forge_cut_sandstone_slab", SigilForgeCutSandstoneSlabBlock::new);
		SIGIL_FORGE_CUT_SANDSTONE_WALL = REGISTRY.register("sigil_forge_cut_sandstone_wall", SigilForgeCutSandstoneWallBlock::new);
		SIGIL_FORGE_CHISELED_SANDSTONE = REGISTRY.register("sigil_forge_chiseled_sandstone", SigilForgeChiseledSandstoneBlock::new);
		SIGIL_FORGE_CHISELED_SANDSTONE_STAIRS = REGISTRY.register("sigil_forge_chiseled_sandstone_stairs", SigilForgeChiseledSandstoneStairsBlock::new);
		SIGIL_FORGE_CHISELED_SANDSTONE_SLAB = REGISTRY.register("sigil_forge_chiseled_sandstone_slab", SigilForgeChiseledSandstoneSlabBlock::new);
		SIGIL_FORGE_CHISELED_SANDSTONE_WALL = REGISTRY.register("sigil_forge_chiseled_sandstone_wall", SigilForgeChiseledSandstoneWallBlock::new);
		DIAMOND_LAMP = REGISTRY.register("diamond_lamp", DiamondLampBlock::new);
		WHITE_DIAMOND_LAMP = REGISTRY.register("white_diamond_lamp", WhiteDiamondLampBlock::new);
		LIGHT_GRAY_DIAMOND_LAMP = REGISTRY.register("light_gray_diamond_lamp", LightGrayDiamondLampBlock::new);
		GRAY_DIAMOND_LAMP = REGISTRY.register("gray_diamond_lamp", GrayDiamondLampBlock::new);
		BLACK_DIAMOND_LAMP = REGISTRY.register("black_diamond_lamp", BlackDiamondLampBlock::new);
		BROWN_DIAMOND_LAMP = REGISTRY.register("brown_diamond_lamp", BrownDiamondLampBlock::new);
		RED_DIAMOND_LAMP = REGISTRY.register("red_diamond_lamp", RedDiamondLampBlock::new);
		ORANGE_DIAMOND_LAMP = REGISTRY.register("orange_diamond_lamp", OrangeDiamondLampBlock::new);
		YELLOW_DIAMOND_LAMP = REGISTRY.register("yellow_diamond_lamp", YellowDiamondLampBlock::new);
		LIME_DIAMOND_LAMP = REGISTRY.register("lime_diamond_lamp", LimeDiamondLampBlock::new);
		GREEN_DIAMOND_LAMP = REGISTRY.register("green_diamond_lamp", GreenDiamondLampBlock::new);
		CYAN_DIAMOND_LAMP = REGISTRY.register("cyan_diamond_lamp", CyanDiamondLampBlock::new);
		LIGHT_BLUE_DIAMOND_LAMP = REGISTRY.register("light_blue_diamond_lamp", LightBlueDiamondLampBlock::new);
		BLUE_DIAMOND_LAMP = REGISTRY.register("blue_diamond_lamp", BlueDiamondLampBlock::new);
		PURPLE_DIAMOND_LAMP = REGISTRY.register("purple_diamond_lamp", PurpleDiamondLampBlock::new);
		MAGENTA_DIAMOND_LAMP = REGISTRY.register("magenta_diamond_lamp", MagentaDiamondLampBlock::new);
		PINK_DIAMOND_LAMP = REGISTRY.register("pink_diamond_lamp", PinkDiamondLampBlock::new);
		SIGIL_FORGE_SMOOTH_SANDSTONE = REGISTRY.register("sigil_forge_smooth_sandstone", SigilForgeSmoothSandstoneBlock::new);
		SIGIL_FORGE_SMOOTH_SANDSTONE_STAIRS = REGISTRY.register("sigil_forge_smooth_sandstone_stairs", SigilForgeSmoothSandstoneStairsBlock::new);
		SIGIL_FORGE_SMOOTH_SANDSTONE_SLAB = REGISTRY.register("sigil_forge_smooth_sandstone_slab", SigilForgeSmoothSandstoneSlabBlock::new);
	...
	//花盆
	public static final DeferredBlock<Block> POTTED_IRON_FLOWER = REGISTRY.register("potted_iron_flower", () -> new FlowerPotBlock(IRON_FLOWER.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_DANDELION)));
	public static final DeferredBlock<Block> POTTED_BLUE_DIAMOND_ROSE = REGISTRY.register("potted_blue_diamond_rose", () -> new FlowerPotBlock(BLUE_DIAMOND_ROSE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_DANDELION)));
	public static final DeferredBlock<Block> POTTED_GILDED_MARIGOLD_FLOWER = REGISTRY.register("potted_gilded_marigold_flower", () -> new FlowerPotBlock(GILDED_MARIGOLD_FLOWER.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_DANDELION)));
	public static final DeferredBlock<Block> POTTED_DEBRIS_SAPLING = REGISTRY.register("potted_debris_sapling", () -> new FlowerPotBlock(DEBRIS_SAPLING.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_DANDELION)));
