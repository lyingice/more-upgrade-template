...
import net.mcreator.mut.potion.DragonClawMobEffect;
...
public class MutModMobEffects {
	...
	public static final DeferredHolder<MobEffect, MobEffect> DRAGON_CLAW = REGISTRY.register("dragon_claw", () -> new DragonClawMobEffect());
}