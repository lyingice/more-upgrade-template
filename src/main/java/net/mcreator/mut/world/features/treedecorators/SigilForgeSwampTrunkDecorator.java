...
@EventBusSubscriber
public class SigilForgeSwampTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<SigilForgeSwampTrunkDecorator> CODEC = MapCodec.unit(SigilForgeSwampTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("mut:sigil_forge_swamp_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
