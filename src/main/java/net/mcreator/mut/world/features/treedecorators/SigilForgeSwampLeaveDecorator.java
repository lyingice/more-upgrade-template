package net.mcreator.mut.world.features.treedecorators;
...
@EventBusSubscriber
public class SigilForgeSwampLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<SigilForgeSwampLeaveDecorator> CODEC = MapCodec.unit(SigilForgeSwampLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("mut:sigil_forge_swamp_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public SigilForgeSwampLeaveDecorator() {
		super(0.25f);
	}
