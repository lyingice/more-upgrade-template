...
public void releaseUsing(ItemStack bowStack, Level world, LivingEntity shooter, int remainingUseTicks) {
    ...
    public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
        ...
        list.add(Component.translatable("item.mut.obsidian_bow.description_0"));
        list.add(Component.translatable("item.mut.obsidian_bow.description_1"));
    }
