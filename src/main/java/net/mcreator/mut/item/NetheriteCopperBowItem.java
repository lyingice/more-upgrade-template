...
public class NetheriteCopperBowItem extends BowItem {
    // 下界合金铜弓拉弓时间：16 tick = 0.8秒（较快）
    public static final int MAX_DRAW_DURATION = 18;
    public static final int DEFAULT_RANGE = 15;
    
    private static final double VANILLA_BASE_DAMAGE = 2.0;

    public NetheriteCopperBowItem() {
