...
public void releaseUsing(ItemStack bowStack, Level world, LivingEntity shooter, int remainingUseTicks) {
    ...
    public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
        ...
        list.add(Component.translatable("item.mut.steel_bow.description_0"));
    }

  @Override
public boolean isValidRepairItem(ItemStack itemstack, ItemStack repairitem) {
    // 使用 MCreator 的物品注册名称
    return Ingredient.of(net.mcreator.mut.init.MutModItems.STEEL_INGOT.get())
            .test(repairitem);
}
}