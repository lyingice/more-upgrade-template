...
public abstract class NetheriteEmeraldItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_netherite")), () -> Ingredient.of(), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("mut:netherite_emerald"))), 3f, 0.1f);
			registerHelper.register(ResourceLocation.parse("mut:netherite_emerald"), armorMaterial);
