...
public abstract class ObsidianItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 1, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_diamond")), () -> Ingredient.of(new ItemStack(Blocks.OBSIDIAN)), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("mut:obsidian"))), 2f,
					0.075f);
			registerHelper.register(ResourceLocation.parse("mut:obsidian"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public ObsidianItem(ArmorItem.Type type, Item.Properties properties) {
