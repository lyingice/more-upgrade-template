...
public class CustomElytraLayer<T extends LivingEntity, M extends EntityModel<T>> extends ElytraLayer<T, M> {
    ...
    public CustomElytraLayer(RenderLayerParent<T, M> renderer, EntityModelSet modelSet) {
    ...
    public boolean shouldRender(ItemStack stack, T entity) {
        return getCustomTexture(stack) != null || super.shouldRender(stack, entity);
    }
    ...
    private ResourceLocation getCustomTexture(ItemStack stack) {
        ...
        } else if (stack.getItem() instanceof CopperElytraItem) {
            return ResourceLocation.parse("mut:textures/entities/copper_elytra.png");
        } else if (stack.getItem() instanceof EmeraldElytraItem) {
            return ResourceLocation.parse("mut:textures/entities/emerald_elytra.png");
        } else if (stack.getItem() instanceof LapisLazuliElytraItem) {
            return ResourceLocation.parse("mut:textures/entities/lapis_lazuli_elytra.png");
        } else if (stack.getItem() instanceof ObsidianElytraItem) {
            return ResourceLocation.parse("mut:textures/entities/obsidian_elytra.png");
        } else if (stack.getItem() instanceof NetherStarElytraItem) {
            return ResourceLocation.parse("mut:textures/entities/nether_star_elytra.png");
        } else if (stack.getItem() instanceof DragonElytraItem) {
            return ResourceLocation.parse("mut:textures/entities/dragon_elytra.png");
        } else if (stack.getItem() instanceof PoisonSteelElytraItem) {
            return ResourceLocation.parse("mut:textures/entities/poison_steel_elytra.png");
        } else if (stack.getItem() instanceof AmethystElytraItem) {
            return ResourceLocation.parse("mut:textures/entities/amethyst_elytra.png");
        }
        return null;
    }
}